...
public class BodyPartFragment extends Fragment {
    ...
    private final static String INDEX_KEY = "image_index";
    private final static String IDS_KEY = "image_ids";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            mImageIds = savedInstanceState.getIntegerArrayList(IDS_KEY);
    ...
    public void onSaveInstanceState(Bundle outState) {
        outState.putIntegerArrayList(IDS_KEY, (ArrayList<Integer>) mImageIds);
